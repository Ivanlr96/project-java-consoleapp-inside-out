...
class MomentDTOTest {
    ...
    void testMomentDTOEqualsAndHashCode() {
        LocalDate date = LocalDate.of(2025, 8, 14);
        MomentDTO dto1 = new MomentDTO("Cumpleaños", date, "Mi cumpleaños", EmotionEnum.ALEGRIA);
        MomentDTO dto2 = new MomentDTO("Cumpleaños", date, "Mi cumpleaños", EmotionEnum.ALEGRIA);
